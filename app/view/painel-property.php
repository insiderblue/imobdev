        ...
        <div class="card text-white bg-secondary shadow-lg mt-4">
            ...
            <div class="card-body bg-white text-dark new_property p-4" style="display: block">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-12">
                        <label required for="property_price" class="form-label">Valor (R$) <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="mb-3 col-12">
                            ...
                            <input required value="<?= $property["property_address"] ?>" type="text" class="form-control" name="property_address" placeholder="">
                        </div>
                        ...
                        <div class="mb-3 col-12">
                            ...
                            <input required value="<?= $city_title ?>" type="text" class="form-control city_show bg-light" disabled name="city_show" placeholder="">
                    ...
                    <div class="row">
                        <div class="mb-3 col-12">
                            ...
                            <textarea required rows="4" class="form-control" name="property_description"><?= $property["property_description"] ?></textarea>
                        </div>
                    </div>
